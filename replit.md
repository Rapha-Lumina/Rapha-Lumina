...
- Email sender: `Rapha Lumina <support@raphalumina.com>` (verified domain)
- Domain verified in Resend for production email delivery.
...
- Both emails sent from: `Rapha Lumina <support@raphalumina.com>` (verified domain)
